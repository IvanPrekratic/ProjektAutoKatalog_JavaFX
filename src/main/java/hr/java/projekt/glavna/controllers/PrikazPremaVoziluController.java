...
public class PrikazPremaVoziluController {
    ...
    public void pretraziKataloski(){
        String kataloski = kataloskiField.getText();
        List<CarPart> filtriraniDijelovi;
        filtriraniDijelovi = dijelovi;
        filtriraniDijelovi = filtriraniDijelovi.stream().filter(dijelovi -> dijelovi.getPartNumber().equals(kataloski)).collect(Collectors.toList());
        ObservableList<CarPart> observableListFiltriraniDijelovi = FXCollections.observableArrayList(filtriraniDijelovi);
